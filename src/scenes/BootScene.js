...
export class BootScene extends Phaser.Scene {
  ...
  createTextures() {
    ...
    for (let [name, color] of Object.entries(skinColors)) {
      g.clear();
      g.fillStyle(color);
      g.fillRoundedRect(12, 12, 56, 32, 8);
      ...
      g.generateTexture(`player_${name}`, 80, 60);
    }
    ...
    // ===== ЛАЗЕРЫ (оставим на будущее, но не используем) =====
    g.clear();
    g.fillStyle(0xff4444);
    g.fillRect(0, 0, 12, 3);
    ...
    // Кнопка магазина (для SkinShopScene)
    g.clear();
    g.fillStyle(0xffaa00);
    g.fillRoundedRect(0, 0, 50, 50, 8);
    ...
    // Кнопка атаки (оставим, но не будем использовать)
    g.clear();
    g.fillStyle(0xff4444);
    g.fillRoundedRect(0, 0, 50, 50, 8);
