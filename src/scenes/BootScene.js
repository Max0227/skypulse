...
export class BootScene extends Phaser.Scene {
  ...
  createTextures() {
    ...
    // ===== СКИНЫ ТАКСИ =====
    const skinConfigs = [
      { id: 'neon', color: 0x00ffff, details: true },
      { id: 'cyber', color: 0xff00ff, details: true },
      { id: 'gold', color: 0xffaa00, details: true },
      { id: 'rainbow', color: 0xff44ff, details: false },
      { id: 'crystal', color: 0x88aaff, details: false },
      { id: 'stealth', color: 0x444444, details: false },
      { id: 'fire', color: 0xff4400, details: true },
      { id: 'ice', color: 0x44aaff, details: true },
      { id: 'void', color: 0x220066, details: false }
    ];

    skinConfigs.forEach(skin => {
      g.clear();
      ...
      g.generateTexture(`player_${skin.id}`, 80, 60);
    });
